...
export default function Home(){return <>
  <Hero/>
  <section id="qip" className="section shell qip-intro"><Reveal><div className="section-heading"><h2>Every new task.<br/>A little less starting over.</h2><p>QIP is our central research project: a way for people and agents to work with shared context, clear boundaries and lessons that last.</p></div><div className="intro-bottom"><span className="caption">Quantum Intelligence Protocol</span><a className="text-link" href="https://rem8ntic.substack.com/p/quantum-intelligence-protocol" target="_blank" rel="noopener noreferrer">Read the thesis <ArrowUpRightIcon size={20}/><span className="sr-only">, opens a new tab</span></a></div></Reveal><div id="the-loop"><QipLoop/></div></section>
